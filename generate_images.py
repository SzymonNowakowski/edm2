...
def velocity_sampler(
    ...
    t_steps = karras_to_descending_time_with_zero(num_steps, device=noise.device, dtype=torch.float64)  #overriding the linear schedule with the time-based equivalent of the default Karras' sigma-schedule for powers of 7
...
@click.option('--sampler_fn_name',          help="Sampler function: [default: 'edm_sampler']", metavar='STR',       type=click.Choice(['edm_sampler', 'velocity_sampler', 'pokar_sampler']), default='edm_sampler', show_default=True)
